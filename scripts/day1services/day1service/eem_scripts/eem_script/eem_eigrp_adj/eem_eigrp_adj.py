...
class EemEigrpAdj(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        #eem_script_eem_eigrp_adj_object = devices.device.eem_script.eem_eigrp_adj.eem_eigrp_adj()
        eem_script_eem_eigrp_adj_object = eem_script.eem_eigrp_adj.eem_eigrp_adj()
        eem_script_eem_eigrp_adj_object.enable_eigrp_adj_eem = inputdict.get('enable_eigrp_adj_eem')
        eem_script_eem_eigrp_adj_object.variable1 = inputdict.get('variable1')
        eem_script_eem_eigrp_adj_object.variable2 = inputdict.get('variable2')
        eem_script_eem_eigrp_adj_object.variable3 = inputdict.get('variable3')


        #End of Device binding
        devbindobjs['eem_script_eem_eigrp_adj_object'] = eem_script_eem_eigrp_adj_object
        ...
        eem_script_eem_eigrp_adj_object_payload = eem_script_eem_eigrp_adj_object.getxml(filter=True)
        #log('eem_script_eem_eigrp_adj_object_payload: %s' % (eem_script_eem_eigrp_adj_object_payload))
        for dev_iterator in dev:
          yang.Sdk.createData(dev_iterator.url+'/eem-script',eem_script_eem_eigrp_adj_object_payload, sdata.getSession(), True)
    ...
    @staticmethod
    def getInstance():
        if(EemEigrpAdj._instance == None):
            EemEigrpAdj._instance = EemEigrpAdj()
        return EemEigrpAdj._instance

    def rollbackCreate(self, id, sdata):
        log('rollback: id = %s, sdata = %s' % (id, sdata))
        self.delete(id,sdata)

if __name__ == 'eem_eigrp_adj':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = EemEigrpAdj().getInstance()
