...
class EemBgpAdj(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        inputdict['enable_bgp_adj_eem'] = config.get_field_value('enable_bgp_adj_eem')
        ...
        eem_script_eem_bgp_adj_object.enable_bgp_adj_eem = inputdict.get('enable_bgp_adj_eem')
        ...
        devbindobjs['eem_script_eem_bgp_adj_object'] = eem_script_eem_bgp_adj_object
        ...
        eem_script_eem_bgp_adj_object_payload = eem_script_eem_bgp_adj_object.getxml(filter=True)
        #log('eem_script_eem_bgp_adj_object_payload: %s' % (eem_script_eem_bgp_adj_object_payload))
        for dev_iterator in dev:
          yang.Sdk.createData(dev_iterator.url+'/l3features:eem-script',eem_script_eem_bgp_adj_object_payload, sdata.getSession(), True)
    ...
    @staticmethod
    def getInstance():
        if(EemBgpAdj._instance == None):
            EemBgpAdj._instance = EemBgpAdj()
        return EemBgpAdj._instance

    def rollbackCreate(self, id, sdata):
        log('rollback: id = %s, sdata = %s' % (id, sdata))
        self.delete(id,sdata)

if __name__ == 'eem_bgp_adj':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = EemBgpAdj().getInstance()
