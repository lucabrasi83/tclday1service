...
class EemMemThreshold(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'eem_mem_threshold')
        ...
        inputdict['enable_mem_threshold_eem'] = config.get_field_value('enable_mem_threshold_eem')
        ...
        if inputdict.get('variable2') is None:
          inputdict['variable2'] = '$_snmp_oid_val'
        ...
        #eem_script_eem_mem_threshold_object = devices.device.eem_script.eem_mem_threshold.eem_mem_threshold()
        eem_script_eem_mem_threshold_object = eem_script.eem_mem_threshold.eem_mem_threshold()
        eem_script_eem_mem_threshold_object.enable_mem_threshold_eem = inputdict.get('enable_mem_threshold_eem')
        eem_script_eem_mem_threshold_object.variable1 = inputdict.get('variable1')
        eem_script_eem_mem_threshold_object.variable2 = inputdict.get('variable2')


        #End of Device binding
        devbindobjs['eem_script_eem_mem_threshold_object'] = eem_script_eem_mem_threshold_object
        ...
        eem_script_eem_mem_threshold_object_payload = eem_script_eem_mem_threshold_object.getxml(filter=True)
        #log('eem_script_eem_mem_threshold_object_payload: %s' % (eem_script_eem_mem_threshold_object_payload))
        for dev_iterator in dev:
          yang.Sdk.createData(dev_iterator.url+'/l3features:eem-script',eem_script_eem_mem_threshold_object_payload, sdata.getSession(), True)
    ...
    @staticmethod
    def getInstance():
        if(EemMemThreshold._instance == None):
            EemMemThreshold._instance = EemMemThreshold()
        return EemMemThreshold._instance

    def rollbackCreate(self, id, sdata):
        log('rollback: id = %s, sdata = %s' % (id, sdata))
        self.delete(id,sdata)

if __name__ == 'eem_mem_threshold':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = EemMemThreshold().getInstance()
