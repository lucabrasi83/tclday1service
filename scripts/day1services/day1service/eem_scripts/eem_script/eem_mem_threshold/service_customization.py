...
/services/day1services/day1service/eem-scripts/eem-script/eem-mem-threshold
"""
"""
...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        tclday0config.tclday0config_grouping_lib.eem_scripts_def_customization.grouping_create_eem_scripts_def_eem_script_eem_mem_threshold(smodelctx, sdata, dev, **kwargs)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        inputdict = kwargs['inputdict']
        import tclday0config.tclday0config_grouping_lib.eem_scripts_def_customization
        tclday0config.tclday0config_grouping_lib.eem_scripts_def_customization.grouping_update_eem_scripts_def_eem_script_eem_mem_threshold(smodelctx, sdata, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        inputdict = kwargs['inputdict']
        import tclday0config.tclday0config_grouping_lib.eem_scripts_def_customization
        tclday0config.tclday0config_grouping_lib.eem_scripts_def_customization.grouping_delete_eem_scripts_def_eem_script_eem_mem_threshold(smodelctx, sdata, **kwargs)
