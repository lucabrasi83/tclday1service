...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        tclday0config.tclday0config_grouping_lib.eem_scripts_def_customization.grouping_create_eem_scripts_def_eem_script_eem_cpu_threshold(smodelctx, sdata, dev, **kwargs)


    @staticmethod
    def process_service_update_data(smodelctx, sdata, **kwargs):
      """callback called for update operation"""
      #raise Exception('Update forbidden  for node eem-cpu-threshold at path day1services/day1service/eem-scripts/eem-script/eem-cpu-threshold')
      modify = False
      if modify and kwargs is not None:
        for key, value in kwargs.iteritems():
          log("%s == %s" %(key,value))
      ...
      if modify:
        ...
        inputdict = kwargs['inputdict']
        import tclday0config.tclday0config_grouping_lib.eem_scripts_def_customization
        tclday0config.tclday0config_grouping_lib.eem_scripts_def_customization.grouping_update_eem_scripts_def_eem_script_eem_cpu_threshold(smodelctx, sdata, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        inputdict = kwargs['inputdict']
        import tclday0config.tclday0config_grouping_lib.eem_scripts_def_customization
        tclday0config.tclday0config_grouping_lib.eem_scripts_def_customization.grouping_delete_eem_scripts_def_eem_script_eem_cpu_threshold(smodelctx, sdata, **kwargs)
