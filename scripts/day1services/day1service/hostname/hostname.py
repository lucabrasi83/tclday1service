...
from servicemodel.controller.devices.device import hostname
...
class Hostname(yang.AbstractYangServiceHandler):
    ...
    def create(self, id, sdata):
        ...
        inputdict['hostname'] = config.get_field_value('hostname')
        ...
        #hostname_object = devices.device.hostname.hostname()
        hostname_object = hostname.hostname()
        hostname_object.hostname = inputdict.get('hostname')

        #End of Device binding
        devbindobjs['hostname_object'] = hostname_object
        ...
        hostname_object_payload = hostname_object.getxml(filter=True)
        log('hostname_object_payload: %s' % (hostname_object_payload))
        for dev_iterator in dev:
          yang.Sdk.createData(dev_iterator.url+'',hostname_object_payload, sdata.getSession(), True)
