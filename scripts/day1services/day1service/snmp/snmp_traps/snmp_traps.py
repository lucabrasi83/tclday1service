...
class SnmpTraps(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'snmp_traps')
        ...
        inputdict['trap'] = config.get_field_value('trap')
        ...
        if util.isNotEmpty(inputdict.get('trap')):
          #snmp_snmp_traps_object = devices.device.snmp.snmp_traps.snmp_traps()
          snmp_snmp_traps_object = snmp.snmp_traps.snmp_traps()
          snmp_snmp_traps_object.snmp_trap = inputdict.get('trap')


        #End of Device binding
        devbindobjs['snmp_snmp_traps_object'] = snmp_snmp_traps_object
        ...
        snmp_snmp_traps_object_payload = snmp_snmp_traps_object.getxml(filter=True)
        log('snmp_snmp_traps_object_payload: %s' % (snmp_snmp_traps_object_payload))
        for dev_iterator in dev:
          yang.Sdk.createData(dev_iterator.url+'/basicDeviceConfigs:snmp',snmp_snmp_traps_object_payload, sdata.getSession(), True)
    ...
    @staticmethod
    def getInstance():
        if(SnmpTraps._instance == None):
            SnmpTraps._instance = SnmpTraps()
        return SnmpTraps._instance

    def rollbackCreate(self, id, sdata):
        log('rollback: id = %s, sdata = %s' % (id, sdata))
        self.delete(id,sdata)

if __name__ == 'snmp_traps':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = SnmpTraps().getInstance()
