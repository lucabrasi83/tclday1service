...
from servicemodel.controller.devices.device import tftp
import service_customization


class Tftp(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'tftp')
        ...
        inputdict['tftp_src_interface'] = config.get_field_value('tftp_src_interface')
        ...
        #tftp_object = devices.device.tftp.tftp()
        tftp_object = tftp.tftp()
        tftp_object.tftp_src_interface = inputdict.get('tftp_src_interface')


        #End of Device binding
        devbindobjs['tftp_object'] = tftp_object
        ...
        tftp_object_payload = tftp_object.getxml(filter=True)
        #log('tftp_object_payload: %s' % (tftp_object_payload))
        for dev_iterator in dev:
          yang.Sdk.createData(dev_iterator.url+'',tftp_object_payload, sdata.getSession(), True)
    ...
    @staticmethod
    def getInstance():
        if(Tftp._instance == None):
            Tftp._instance = Tftp()
        return Tftp._instance
