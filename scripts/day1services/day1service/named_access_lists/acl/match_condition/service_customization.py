...
class ServiceDataCustomization:
    ...
    def process_service_device_bindings(smodelctx, sdata, dev, **kwargs):
      ...
      if modify:
        ...
        tclday0config.tclday0config_grouping_lib.access_lists_def_customization.grouping_create_access_lists_def_acl_match_condition(smodelctx, sdata, dev, **kwargs)
    ...
    def process_service_delete_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        inputdict = kwargs['inputdict']
        import tclday0config.tclday0config_grouping_lib.access_lists_def_customization
        tclday0config.tclday0config_grouping_lib.access_lists_def_customization.grouping_delete_access_lists_def_acl_match_condition(smodelctx, sdata, **kwargs)
