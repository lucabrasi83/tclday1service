...
#        tclday0config.tclday0config_grouping_lib.common_config_def_customization.grouping_create_common_config_def_policy_maps_policy_map(smodelctx, sdata, dev, xpath='day1services/day1service/policy-maps/policy-map', **kwargs)
    ...
    def process_service_update_data(smodelctx, sdata, **kwargs):
      ...
      if modify:
        ...
        dev = kwargs['dev']
#        import tclday0config.tclday0config_grouping_lib.common_config_def_customization
#        tclday0config.tclday0config_grouping_lib.common_config_def_customization.grouping_update_common_config_def_policy_maps_policy_map(smodelctx, sdata, xpath='day1services/day1service/policy-maps/policy-map', **kwargs)
 ...
 #       import tclday0config.tclday0config_grouping_lib.common_config_def_customization
 #       tclday0config.tclday0config_grouping_lib.common_config_def_customization.grouping_delete_common_config_def_policy_maps_policy_map(smodelctx, sdata, xpath='day1services/day1service/policy-maps/policy-map', **kwargs)
