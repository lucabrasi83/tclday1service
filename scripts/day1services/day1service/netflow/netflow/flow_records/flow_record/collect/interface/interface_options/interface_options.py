...
class InterfaceOptions(yang.AbstractYangServiceHandler):
    _instance = None
    ...
    def create(self, id, sdata):
        ...
        config = getCurrentObjectConfig(id, sdata, 'interface_options')
        ...
        inputdict['interface_option'] = config.get_field_value('interface_option')
        ...
        if util.isNotEmpty(inputdict['interface_option']):
        	dev_pro_name = "collect_interface_%s" % (inputdict['interface_option'])
        ...
        if util.isNotEmpty(inputdict.get('day1services_day1service_netflow_netflow_flow_records_flow_record_name')):
          ...
          netflow_flow_records_flow_record_collect_interface_object = devices.device.netflow.flow_records.flow_record.collect.interface.interface()
          if util.isNotEmpty(inputdict.get('name')):
            netflow_flow_records_flow_record_collect_interface_interface_options_object = devices.device.netflow.flow_records.flow_record.collect.interface.interface_options.interface_options()
            netflow_flow_records_flow_record_collect_interface_interface_options_object.name = dev_pro_name
            netflow_flow_records_flow_record_collect_interface_interface_options_object.interface_option = inputdict.get('interface_option')


        #End of Device binding
        devbindobjs['netflow_flow_records_flow_record_collect_interface_interface_options_object'] = netflow_flow_records_flow_record_collect_interface_interface_options_object
        ...
        for dev_iterator in dev:
            ...
            if not yang.Sdk.dataExists(dev_iterator.url+'/l3features:netflow/flow-records/flow-record=%s/collect/interface'%(util.make_interfacename(inputdict.get('day1services_day1service_netflow_netflow_flow_records_flow_record_name')))):
                yang.Sdk.createData(dev_iterator.url+'/l3features:netflow/flow-records/flow-record=%s/collect'%(util.make_interfacename(inputdict.get('day1services_day1service_netflow_netflow_flow_records_flow_record_name'))),'<interface/>', sdata.getSession(), False)


        netflow_flow_records_flow_record_collect_interface_interface_options_object_payload = netflow_flow_records_flow_record_collect_interface_interface_options_object.getxml(filter=True)
        log('netflow_flow_records_flow_record_collect_interface_interface_options_object_payload: %s' % (netflow_flow_records_flow_record_collect_interface_interface_options_object_payload))
        for dev_iterator in dev:
          yang.Sdk.createData(dev_iterator.url+'/l3features:netflow/flow-records/flow-record=%s/collect/interface'%(util.make_interfacename(inputdict.get('day1services_day1service_netflow_netflow_flow_records_flow_record_name'))),netflow_flow_records_flow_record_collect_interface_interface_options_object_payload, sdata.getSession(), True)
    ...
    @staticmethod
    def getInstance():
        if(InterfaceOptions._instance == None):
            InterfaceOptions._instance = InterfaceOptions()
        return InterfaceOptions._instance

if __name__ == 'interface_options':
  from servicemodel.yang import YangServiceData
  sdata = YangServiceData()
  instance = InterfaceOptions().getInstance()
