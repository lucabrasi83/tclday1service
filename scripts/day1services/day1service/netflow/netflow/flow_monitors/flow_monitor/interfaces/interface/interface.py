    ...
    def create(self, id, sdata):
        ...
        if util.isNotEmpty(inputdict.get('day1services_day1service_netflow_netflow_flow_monitors_flow_monitor_name')):
          ...
          if util.isNotEmpty(inputdict.get('interface')):
            ...
            netflow_flow_monitors_flow_monitor_interfaces_interface_object.interface = inputdict.get('interface')


        #End of Device binding
        devbindobjs['netflow_flow_monitors_flow_monitor_interfaces_interface_object'] = netflow_flow_monitors_flow_monitor_interfaces_interface_object
        ...
        for dev_iterator in dev:
            if not yang.Sdk.dataExists(dev_iterator.url+'/l3features:netflow/flow-monitors/flow-monitor=%s/interfaces'%(util.make_interfacename(inputdict.get('day1services_day1service_netflow_netflow_flow_monitors_flow_monitor_name')))):
                yang.Sdk.createData(dev_iterator.url+'/l3features:netflow/flow-monitors/flow-monitor=%s'%(util.make_interfacename(inputdict.get('day1services_day1service_netflow_netflow_flow_monitors_flow_monitor_name'))),'<interfaces/>', sdata.getSession(), False)


        netflow_flow_monitors_flow_monitor_interfaces_interface_object_payload = netflow_flow_monitors_flow_monitor_interfaces_interface_object.getxml(filter=True)
        ...
        for dev_iterator in dev:
          yang.Sdk.createData(dev_iterator.url+'/l3features:netflow/flow-monitors/flow-monitor=%s/interfaces'%(util.make_interfacename(inputdict.get('day1services_day1service_netflow_netflow_flow_monitors_flow_monitor_name'))),netflow_flow_monitors_flow_monitor_interfaces_interface_object_payload, sdata.getSession(), True)
