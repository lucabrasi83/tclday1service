...
"""
def grouping_create_http_def_(smodelctx, sdata, dev, **kwargs):
    pass
...
Fetch the parent object using getParentObject() API 
"""
def grouping_update_http_def_(smodelctx, sdata, **kwargs):
    pass
...
Fetch the parent object using getParentObject() API 
"""
def grouping_delete_http_def_(smodelctx, sdata, **kwargs):
    pass
